...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values=filtered_df.index, names='class',
...
def get_scatter_chart(entered_site,payload_mass):
    ...
    if entered_site == 'ALL':
        ...
        color='Booster Version Category', title=f'Success Rate based on Payload Mass (kg) of {payload_mass[0]} to {payload_mass[1]} w/Booster Version Marked')
        return fig
    else:
        filtered_df = filtered_df[filtered_df['Launch Site']==entered_site]
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class',color='Booster Version Category',
        title=f'{entered_site} Success rate based on Payload Mass (kg) of {payload_mass[0]} to {payload_mass[1]} w/Booster Version Marked')
        return fig
